$(document).ready(function () {
    ...
    $.ajax({
            ...
            <div class="tw-latest-post" style="text-align:left">
                ...
                <div class="post-body" style="height: 500px; overflow-y : scroll">
                    ...
                    <div class="post-info">
                        ...
                        <!-- End Entry Content -->
                        <a href="http://blog.chamaralabs.com/article/posts/${blogs[j].encode_id}/${blogs[j].slug}" class="tw-readmore">Read More
        ...
        <!-- End Col -->`;
            ...
            <a href="http://blog.chamaralabs.com/article/posts" class="btn btn-primary">view all</a>
        </div>`
