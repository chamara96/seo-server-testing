...
function setSlick() {
    ...
    for (let i = 0; i < merchants.length; i++) {
        ...
        html = `<div class="slide cont" style="padding: 5px 10px"><a target="_blank" rel="noopener noreferrer" href="${merchants[i].web_url}" > <div class="port wow fadeIn">
                 <img  src="http://blog.chamaralabs.com/${merchants[i].image_url}" />
